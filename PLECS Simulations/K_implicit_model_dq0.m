...
% Constant Q Matrix
Qdiag  = [1/(dV_max^2)*ones(1,3),1/(dI_max^2)*ones(1,2),0,1e7*ones(1,3),5e6*ones(1,2),1/(dV_max^2)*ones(1,3),1/(dI_max^2)*ones(1,2),0];
Q = diag(Qdiag);
...
Kclark = 2/3*[1,-0.5,-0.5;0 sqrt(3)/2 -sqrt(3)/2;1/3,1/3,1/3]; %clark transform for ABC (In this case more like ACB) 
