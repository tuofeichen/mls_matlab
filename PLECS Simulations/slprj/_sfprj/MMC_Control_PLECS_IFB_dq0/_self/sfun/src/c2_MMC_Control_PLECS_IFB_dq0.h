#ifndef __c2_MMC_Control_PLECS_IFB_dq0_h__
#define __c2_MMC_Control_PLECS_IFB_dq0_h__
...
#ifndef typedef_SFc2_MMC_Control_PLECS_IFB_dq0InstanceStruct
#define typedef_SFc2_MMC_Control_PLECS_IFB_dq0InstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_MMC_Control_PLECS_IFB_dq0;
  ...
  real_T (*c2_Vg_meas)[3];
  real_T *c2_trigger;
} SFc2_MMC_Control_PLECS_IFB_dq0InstanceStruct;

#endif                                 /*typedef_SFc2_MMC_Control_PLECS_IFB_dq0InstanceStruct*/
...
extern void sf_c2_MMC_Control_PLECS_IFB_dq0_get_check_sum(mxArray *plhs[]);
extern void c2_MMC_Control_PLECS_IFB_dq0_method_dispatcher(SimStruct *S, int_T
  method, void *data);
