...
static void initialize_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void initialize_params_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void enable_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void disable_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void set_sim_state_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void sf_gateway_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void mdl_start_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void c2_chartstep_c2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void initSimStructsc2_MMC_Control_PLECS_IFB
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_phi_val, const char_T *c2_identifier,
  boolean_T *c2_svPtr);
static real_T c2_b_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_err_int_val, const char_T *c2_identifier,
  boolean_T *c2_svPtr, real_T c2_b_y[5]);
static void c2_d_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T *c2_svPtr, real_T c2_b_y[5]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_D_out_val, const char_T *c2_identifier,
  boolean_T *c2_svPtr, real_T c2_b_y[6]);
static void c2_f_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T *c2_svPtr, real_T c2_b_y[6]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_phi, const char_T *c2_identifier);
static real_T c2_h_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_i_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_D_out, const char_T *c2_identifier, real_T
  c2_b_y[6]);
static void c2_j_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[6]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_k_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  c2_struct_ojzwK8Jz45Am72HbWmwUdE *c2_b_y);
static void c2_l_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[1800]);
static void c2_m_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[19800]);
static void c2_n_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[300]);
...
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_o_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[66]);
...
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_p_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[5]);
...
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_q_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[36]);
...
static const mxArray *c2_k_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_r_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[30]);
...
static const mxArray *c2_l_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_s_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[66]);
static void c2_k_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static real_T c2_asin(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance,
                      real_T c2_b_x);
static void c2_error(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static real_T c2_interp1(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance,
  real_T c2_varargin_1[300], real_T c2_varargin_2[300], real_T c2_varargin_3);
static void c2_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void c2_StringToMethodID(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void c2_b_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static boolean_T c2_isnan(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, real_T c2_b_x);
static void c2_b_error(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static void c2_c_error(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static real_T c2_ceil(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance,
                      real_T c2_b_x);
static void c2_c_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void c2_d_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void c2_e_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void c2_f_scalarEg(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void c2_dimagree(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance);
static const mxArray *c2_m_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_t_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_l_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_u_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MMC_Control_PLECS_IFB, const
  char_T *c2_identifier);
static uint8_T c2_v_emlrt_marshallIn(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_asin(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance,
                      real_T *c2_b_x);
static void c2_b_ceil(SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance,
                      real_T *c2_b_x);
static void init_dsm_address_info(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_MMC_Control_PLECS_IFBInstanceStruct
  *chartInstance);
  ...
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_MMC_Control_PLECS_IFB(chartInstance);
  ...
  chartInstance->c2_is_active_c2_MMC_Control_PLECS_IFB = 0U;
}
  ...
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_MMC_Control_PLECS_IFB;
  ...
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_phi = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_MMC_Control_PLECS_IFB = c2_u_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(
       "is_active_c2_MMC_Control_PLECS_IFB", c2_b_u, 5)),
     "is_active_c2_MMC_Control_PLECS_IFB");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_MMC_Control_PLECS_IFB(chartInstance);
  ...
  (SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_MMC_Control_PLECS_IFB(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_MMC_Control_PLECS_IFBMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance;
  chartInstance = (SFc2_MMC_Control_PLECS_IFBInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_MMC_Control_PLECS_IFB_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_b_y = c2_v_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MMC_Control_PLECS_IFB), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MMC_Control_PLECS_IFB);
  return c2_b_y;
}
...
void sf_c2_MMC_Control_PLECS_IFB_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4205312768U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1428297316U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2098883824U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2171966820U);
}

mxArray* sf_c2_MMC_Control_PLECS_IFB_get_post_codegen_info(void);
mxArray *sf_c2_MMC_Control_PLECS_IFB_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("eSlXtVdsqv1u8d1mYvuSlD");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_MMC_Control_PLECS_IFB_get_post_codegen_info();
...
mxArray *sf_c2_MMC_Control_PLECS_IFB_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MMC_Control_PLECS_IFB_jit_fallback_info(void)
{
...
mxArray *sf_c2_MMC_Control_PLECS_IFB_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_MMC_Control_PLECS_IFB(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"D_out\",},{M[1],M[16],T\"phi\",},{M[4],M[0],T\"D_out_val\",S'l','i','p'{{M1x2[74 83],M[0],}}},{M[4],M[0],T\"err_int_val\",S'l','i','p'{{M1x2[84 95],M[0],}}},{M[4],M[0],T\"phi_val\",S'l','i','p'{{M1x2[96 103],M[0],}}},{M[8],M[0],T\"is_active_c2_MMC_Control_PLECS_IFB\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_MMC_Control_PLECS_IFB_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance =
      (SFc2_MMC_Control_PLECS_IFBInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _MMC_Control_PLECS_IFBMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        init_script_number_translation(_MMC_Control_PLECS_IFBMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_MMC_Control_PLECS_IFBMachineNumber_,
        ...
        _SFD_CV_INIT_EML_IF(0,1,1,227,237,1600,1651);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _MMC_Control_PLECS_IFBMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "sVZZ2J1MhBLFOkjOrYGFeWD";
}

static void sf_opaque_initialize_c2_MMC_Control_PLECS_IFB(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MMC_Control_PLECS_IFB
    ((SFc2_MMC_Control_PLECS_IFBInstanceStruct*) chartInstanceVar);
  initialize_c2_MMC_Control_PLECS_IFB((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_MMC_Control_PLECS_IFB(void *chartInstanceVar)
{
  enable_c2_MMC_Control_PLECS_IFB((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_MMC_Control_PLECS_IFB(void *chartInstanceVar)
{
  disable_c2_MMC_Control_PLECS_IFB((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_MMC_Control_PLECS_IFB(void *chartInstanceVar)
{
  sf_gateway_c2_MMC_Control_PLECS_IFB((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_MMC_Control_PLECS_IFB(SimStruct*
  S)
{
  return get_sim_state_c2_MMC_Control_PLECS_IFB
    ((SFc2_MMC_Control_PLECS_IFBInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_MMC_Control_PLECS_IFB(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c2_MMC_Control_PLECS_IFB
    ((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_MMC_Control_PLECS_IFB(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MMC_Control_PLECS_IFBInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c2_MMC_Control_PLECS_IFB((SFc2_MMC_Control_PLECS_IFBInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_MMC_Control_PLECS_IFB
    ((SFc2_MMC_Control_PLECS_IFBInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MMC_Control_PLECS_IFB(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MMC_Control_PLECS_IFB(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_MMC_Control_PLECS_IFB_optimization_info
  ...
  ssSetChecksum0(S,(1077271221U));
  ssSetChecksum1(S,(347771645U));
  ssSetChecksum2(S,(3485986266U));
  ssSetChecksum3(S,(35740611U));
...
static void mdlRTW_c2_MMC_Control_PLECS_IFB(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MMC_Control_PLECS_IFB(SimStruct *S)
{
  SFc2_MMC_Control_PLECS_IFBInstanceStruct *chartInstance;
  chartInstance = (SFc2_MMC_Control_PLECS_IFBInstanceStruct *)utMalloc(sizeof
    (SFc2_MMC_Control_PLECS_IFBInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_MMC_Control_PLECS_IFBInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MMC_Control_PLECS_IFB;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MMC_Control_PLECS_IFB;
  ...
  mdl_start_c2_MMC_Control_PLECS_IFB(chartInstance);
}

void c2_MMC_Control_PLECS_IFB_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MMC_Control_PLECS_IFB(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MMC_Control_PLECS_IFB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MMC_Control_PLECS_IFB(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MMC_Control_PLECS_IFB_method_dispatcher.\n"
