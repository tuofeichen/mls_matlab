...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_MMC_Control_PLECS_IFB_diode_ab0_process_check_sum_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_MMC_Control_PLECS_IFB_diode_ab0_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_MMC_Control_PLECS_IFB_diode_ab0_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "MMC_Control_PLECS_IFB_diode_ab0") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_MMC_Control_PLECS_IFB_diode_ab0_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_MMC_Control_PLECS_IFB_diode_ab0_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "MMC_Control_PLECS_IFB_diode_ab0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_MMC_Control_PLECS_IFB_diode_ab0_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_MMC_Control_PLECS_IFB_diode_ab0_jit_fallback_info( int
  ...
  if (strcmp(machineName, "MMC_Control_PLECS_IFB_diode_ab0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_MMC_Control_PLECS_IFB_diode_ab0_jit_fallback_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_MMC_Control_PLECS_IFB_diode_ab0_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "MMC_Control_PLECS_IFB_diode_ab0") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_MMC_Control_PLECS_IFB_diode_ab0_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_MMC_Control_PLECS_IFB_diode_ab0_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "MMC_Control_PLECS_IFB_diode_ab0") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_MMC_Control_PLECS_IFB_diode_ab0_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_MMC_Control_PLECS_IFB_diode_ab0_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"MMC_Control_PLECS_IFB_diode_ab0")) {
    return(sf_MMC_Control_PLECS_IFB_diode_ab0_method_dispatcher(simstructPtr,
...
extern void MMC_Control_PLECS_IFB_diode_ab0_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    MMC_Control_PLECS_IFB_diode_ab0_terminator();
...
extern void MMC_Control_PLECS_IFB_diode_ab0_initializer(void);
extern void MMC_Control_PLECS_IFB_diode_ab0_register_exported_symbols(SimStruct*
  S);
extern void MMC_Control_PLECS_IFB_diode_ab0_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  MMC_Control_PLECS_IFB_diode_ab0_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      MMC_Control_PLECS_IFB_diode_ab0_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    MMC_Control_PLECS_IFB_diode_ab0_initializer();
  }
